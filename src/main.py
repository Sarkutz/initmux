...
config_file = '~/.config/initmux/config.yml'
config_file = 'samples/config.yml'

wsdir  = '~/.config/initmux/wspaces'
ymldir = '~/.config/initmux/yamls'
...
if config:
    wsdir  = os.path.expanduser(config.get('wsdir' ,wsdir ))
    ymldir = os.path.expanduser(config.get('ymldir',ymldir))

# Definition of Argument Options
